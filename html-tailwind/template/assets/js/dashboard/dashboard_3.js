...
(function () {
  ...
  var options = {
    ...
    colors: ["rgba(var(--theme-default),1)", "#FFA941"],
    ...
    legend: {
      ...
      fontWeight: 500,
      labels: {
        colors: "rgba(var(--chart-text-color),1)",
      },
      markers: {
        width: 6,
        height: 6,
  ...
  var optionslearning = {
    ...
    grid: {
      show: true,
      borderColor: "rgba(var(--chart-border),1)",
      xaxis: {
        lines: {
          show: true,
        },
    ...
    colors: ["rgba(var(--theme-default),1)", "#F47DEA", "#FFA941", "#FFC200", "#54BA4A", "#3DA831", "#57B9F6", "#FF3377", "#773ACE", "#945CFF", "#7366ff"],
    stroke: {
      width: 1.5,
      curve: "smooth",
    },
  ...
  var optionsactivity = {
    ...
    grid: {
      borderColor: "rgba(var(--chart-dashed-border),1)",
      strokeDashArray: 5,
    },
  ...
  var upcomingoptions = {
        ...
        data: [
          {
            ...
            strokeColor: "rgba(var(--theme-default),1)",
            fillColor: "rgba(var(--white-bg),1)",
          },
          {
            x: "Marketing",
    ...
    dataLabels: {
      ...
      background: {
        enabled: true,
        foreColor: "rgba(var(--chart-text-color),1)",
        padding: 10,
        borderRadius: 12,
        borderWidth: 1,
        opacity: 0.9,
    ...
    grid: {
      row: {
        colors: ["rgba(var(--light-background),1)", "rgba(var(--white-bg),1)"],
        opacity: 1,
      },
    },
    stroke: {
  ...
  const lesson1 = {
    color: ["rgba(var(--theme-default),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)"],
  ...
  // lesson vue data
  const lesson2 = {
    color: ["rgba(var(--theme-default),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)"],
  ...
  const lesson3 = {
    color: ["rgba(var(--theme-default),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)", "rgba(var(--chart-progress-light),1)"],
