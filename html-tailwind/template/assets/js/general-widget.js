...
(function () {
  ...
  const radial1 = {
    ...
    dropshadowColor: "rgba(var(--theme-default),1)",
    radialYseries: [78],
  };
  ...
  const radial6 = {
    ...
    dropshadowColor: "rgba(var(--theme-secondary),1)",
    radialYseries: [60],
  };
  ...
  var userAnalytics = {
    ...
    colors: ["rgba(var(--theme-default),1)", "rgba(115, 102, 255, 0.13)", "rgba(115, 102, 255, 0.33)", "rgba(115, 102, 255, 0.62)", "rgba(115, 102, 255, 0.09)"],
    responsive: [
      {
        breakpoint: 576,
        options: {
